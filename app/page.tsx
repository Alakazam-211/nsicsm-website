...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-cyan-50">
      ...
      {/* Hero Section */}
      <section className="relative pt-24 sm:pt-32 md:pt-40 pb-12 sm:pb-16 md:pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          >
            ...
            <GlassButton variant="primary" href="#contact" className="text-base sm:text-lg px-6 sm:px-8 py-3 sm:py-4">
              CONTACT US
            </GlassButton>
          </motion.div>
        </div>
      ...
      <section id="services" className="py-12 sm:py-16 md:py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-3 sm:mb-4 text-gray-800">Our Services</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
            {services.map((service, index) => (
              ...
              >
                <GlassCard className="h-full p-6 sm:p-8 hover:scale-105 transition-transform duration-300">
                  <div className="mb-4 sm:mb-6 flex items-center justify-center">{service.icon}</div>
                  <h3 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4 text-gray-800">{service.title}</h3>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            <GlassCard className="p-6 sm:p-8 md:p-12">
              ...
              <GlassButton variant="primary" href="#contact" className="text-base sm:text-lg px-6 sm:px-8 py-3 sm:py-4 w-full sm:w-auto">
                Contact Us
              </GlassButton>
            </GlassCard>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
              {/* About Us / Our Story */}
              <GlassCard className="p-6 sm:p-8 md:p-12">
                <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4 sm:mb-6 text-gray-800">Our Story</h2>
                ...
                <div className="mt-6 sm:mt-8 pt-6 sm:pt-8 border-t border-gray-200">
                  <h3 className="text-lg sm:text-xl font-semibold mb-3 sm:mb-4 text-gray-800">Get in Touch</h3>
                  <div className="space-y-2 sm:space-y-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm sm:text-base text-gray-700">
                        <a href="tel:225-316-0253" className="hover:text-blue-600 transition-colors">225-316-0253</a>
                      </p>
                    </div>
                    <div>
                      <p className="text-sm sm:text-base text-gray-700 font-semibold mb-1">
              ...
              {/* Contact Form */}
              <GlassCard className="p-6 sm:p-8 md:p-12">
                <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4 sm:mb-6 text-gray-800">Contact Us</h2>
      ...
      {/* Footer */}
      <footer className="py-12 sm:py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 mb-8 sm:mb-12">
            ...
            {/* Services */}
            <div>
              <h4 className="text-base sm:text-lg font-semibold mb-3 sm:mb-4 text-gray-800">Services</h4>
              <ul className="space-y-2">
                <li>
                  <a href="#services" className="text-sm sm:text-base text-gray-600 hover:text-gray-800 transition-colors">
            ...
            {/* Company */}
            <div>
              <h4 className="text-base sm:text-lg font-semibold mb-3 sm:mb-4 text-gray-800">Company</h4>
              <ul className="space-y-2">
                <li>
                  <a href="#contact" className="text-sm sm:text-base text-gray-600 hover:text-gray-800 transition-colors">
                    Contact
                  </a>
                </li>
                <li>
          ...
          {/* Bottom Bar */}
          <div className="border-t border-gray-200 pt-6 sm:pt-8 flex flex-col sm:flex-row justify-between items-center">
